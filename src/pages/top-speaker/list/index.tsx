...
import { getTopSpeakers, setTopSpeakerId } from "../../../../store/actions/topSpeaker";
        ...
        {(props) => (
          <div>
            ...
            <p className="table-description text-muted">
              *If you experience any difficulty in viewing the top Speaker information, please make sure your cache is cleared
