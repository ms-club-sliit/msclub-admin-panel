...
const WebinarList: React.FC = () => {
  ...
  const tableColumnData = [
    {
      dataField: "actions",
      text: "Actions",
      formatter: (cell: any, row: IWebinar) => '####',
  ...
  //           <span className="dropdown-item" onClick={(e) => handleSetViewWebinar(row._id)}>
  //             <i className="far fa-eye" /> View
  //           </span>
  //           <span className="dropdown-item" onClick={(e) => handleSetUpdateWebinar(row._id)}>
  //             <i className="far fa-edit" /> Edit
  //           </span>
  //           <button className="dropdown-item" onClick={(e) => handleSetDeleteWebinar(row._id)}>
  ...
  const handleDeletedWebinarClick = (Webinars: any) => {
        ...
        {(props) => (
          <div>
            ...
            <p className="table-description text-muted">
              *If you experience any difficulty in viewing the webinar information, please make sure your cache is cleared
