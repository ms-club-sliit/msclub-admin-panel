            ...
            <span className="dropdown show">
                <span className="dropdown">
                    ...
                    <div className="dropdown-menu dropdown-menu-right">
                        <span className="dropdown-item" onClick={(e) => handleSetViewApplication(row._id)}>
                            <i className="far fa-eye" /> View
                        </span>
                        <button className="dropdown-item" onClick={(e) => handleSetDeleteApplication(row._id)}>
                ...
                {(props) => (
                    <div>
                        ...
                        <p className="table-description text-muted">
                            *If you experience any difficulty in viewing the application information, please make sure your cache is cleared
