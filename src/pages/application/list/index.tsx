...
const ApplicationList: React.FC = () => {
  ...
  const [selectedTypeApplications, setSelectedTypeApplications] =
        ...
        <span className="dropdown">
          ...
          <div className="dropdown-menu dropdown-menu-right">
            <span
              ...
              onClick={(e) => handleSetViewApplication(row._id)}
            >
              <i className="far fa-eye" /> View
            </span>
            <button
              className="dropdown-item"
              onClick={(e) => handleSetDeleteApplication(row._id)}
            >
    ...
    Promise.resolve()
      ...
      .then((data) => {
        if (data === "All") {
          ...
          setSelectedTypeApplications(
            applications.filter((application) => application.deletedAt !== null)
          );
        }
      });
  };
    ...
    <div className="card">
      <div className="row">
        <div className="col-6">
          ...
          <p className="page-description text-muted">
            Manage all the application informations
          </p>
        </div>
      </div>
      ...
      <div>
        <div className="d-flex">
          ...
          <button
            className={`btn btn-sm ${
              selectedTab === "PENDING" ? "btn-info" : "btn-light"
            } btn-rounded shadow-none`}
        ...
        {(props) => (
          <div>
            ...
            <p className="table-description text-muted">
              *If you experience any difficulty in viewing the application
