...
import { getDeletedApplications, recoverDeletedApplication, setApplicationId } from "../../../store/application-store/applicationActions";
...
const RecoverDeletedApplication: React.FC = () => {
    ...
    useEffect(() => {
        let applicationData = state.deletedApplications.find((application: IApplication) => application._id === state.selectedApplicationId);
